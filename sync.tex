...
When two Game Boys are linked and not playing, copying groove/phrase/instr/table/synth data on the master Game Boy will also transfer the copied data so it can be pasted on the slave Game Boy.
