...
When two Game Boys are linked and not playing, copying groove, phrase, instr, table or synth data on one Game Boy will transfer the copied data so it can be pasted on the other Game Boy.
