...
You can now try to move the cursor up and down and insert more notes in other positions.
...
The \textsc{type} field sets the instrument type. The instrument types are specific for different
