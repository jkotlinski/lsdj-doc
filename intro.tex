...
can move around between the different channels using the directional pad.
\begin{figure}[hbtp]
\centering
...
directional pad. \textsc{a+left/right} changes the note, and \textsc{a+up/down} changes octave.
