...
The pitch command works on pulse and wave channels. When used on \textsc{kit} instruments, it sounds more like a pitch shifter. The actual speed depends on whether the instrument is set to \textsc{hf} or normal vibrato. In \textsc{hf} mode, pitch will be updated at 360 Hz, otherwise pitch update happens at regular ticks.
