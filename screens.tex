...
\begin{description}
    ...
    \item[\textsc{p.speed}] \textsc{P} command pitch bend speed. \textsc{Fast} bends at 360 Hz, \textsc{slow} bends every tick, \textsc{step} changes the pitch once and immediately.
\end{description}
