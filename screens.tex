...
Instruments don't automatically play in a matching channel. It is your job to make sure the instrument type matches the channel you are using. For example, to use the kit instrument, first make sure that you are in the wave channel:
