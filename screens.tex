...
\begin{description}
    ...
    \item[\textsc{tuning}]
        ...
        \end{description}
    \item[\textsc{table}] If set to values other than \textsc{off}, Little Sound Dj will start running the specified table when a note is played. If you want to edit the table, press \textsc{select+right} to get to the table screen. To create a new table, press \textsc{a,a}. To clone the table, press \textsc{select+(b,a)}.
