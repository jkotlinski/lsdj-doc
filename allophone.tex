...
This allophone list is copied from the General Instrument SP0256-AL2 datasheet. To learn more about how to program this amazing chip, find the datasheet online.
...
\begin{description}
	...
	\item[*UH] cookie, full
	\item[*AO] talking, song
	\item[*AX] lapel, instruct
	\item[*AA] pottery, cotton
\end{description}
