...
Tables \ref{tab:sram-pulse} to \ref{tab:sram-noise} show the SRAM layout of the different instrument types. Each instrument takes up 16 bytes in the instrument parameter area in \nameref{sram-instr-param}.
